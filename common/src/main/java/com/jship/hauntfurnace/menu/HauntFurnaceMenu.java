...
public class HauntFurnaceMenu extends AbstractFurnaceMenu {
    public HauntFurnaceMenu(int i, Inventory inventory) {
        super(ModMenus.HAUNT_FURNACE.get(), ModRecipes.HAUNTING.get(), RecipeBookType.FURNACE, i, inventory);
    }

    public HauntFurnaceMenu(int i, Inventory inventory, Container container, ContainerData containerData) {
        super(ModMenus.HAUNT_FURNACE.get(), ModRecipes.HAUNTING.get(), RecipeBookType.FURNACE, i, inventory, container, containerData);
    }
