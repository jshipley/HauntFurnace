...
public class PoweredEnderFurnaceRecipeBookComponent extends RecipeBookComponent<PoweredEnderFurnaceMenu> {
    ...
    public PoweredEnderFurnaceRecipeBookComponent(PoweredEnderFurnaceMenu menu, List<RecipeBookComponent.TabInfo> tabInfos) {
        super(menu, tabInfos);
    }
    ...
    protected void fillGhostRecipe(GhostSlots ghostSlots, RecipeDisplay recipeDisplay, ContextMap contextMap) {
        ghostSlots.setResult(((PoweredEnderFurnaceMenu)this.menu).getResultSlot(), contextMap, recipeDisplay.result());
        if (recipeDisplay instanceof FurnaceRecipeDisplay furnaceRecipeDisplay) {
            ghostSlots.setInput((Slot)((PoweredEnderFurnaceMenu)this.menu).slots.get(0), contextMap, furnaceRecipeDisplay.ingredient());
        }
    }
