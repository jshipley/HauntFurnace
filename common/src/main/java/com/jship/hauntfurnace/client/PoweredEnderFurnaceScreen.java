...
public class PoweredEnderFurnaceScreen extends AbstractRecipeBookScreen<PoweredEnderFurnaceMenu> {

    public static final ResourceLocation TEXTURE = HauntFurnace.id("textures/gui/container/powered_ender_furnace.png");
    public static final ResourceLocation POWERED_PROGRESS_TEXTURE = HauntFurnace.id("container/ender_furnace/powered_progress");
    ...
    public PoweredEnderFurnaceScreen(PoweredEnderFurnaceMenu menu, Inventory inventory, Component title) {
        super(menu, new PoweredEnderFurnaceRecipeBookComponent(menu, EnderFurnaceScreen.TABS), inventory, title);
    }
