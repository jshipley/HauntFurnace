...
public class HauntFurnace {
    ...
    public static Supplier<Block> ENDER_FURNACE_BLOCK;
    public static Supplier<Item> ENDER_FURNACE_ITEM;
    public static Supplier<BlockEntityType<EnderFurnaceBlockEntity>> ENDER_FURNACE_BLOCK_ENTITY;

    public static Supplier<Block> POWERED_ENDER_FURNACE_BLOCK;
    public static Supplier<Item> POWERED_ENDER_FURNACE_ITEM;
    public static Supplier<BlockEntityType<PoweredEnderFurnaceBlockEntity>> POWERED_ENDER_FURNACE_BLOCK_ENTITY;

    public static Supplier<Block> GILDED_END_STONE_BLOCK;
    public static Supplier<Item> GILDED_END_STONE_ITEM;
    ...
    public static Supplier<RecipeType<CorruptingRecipe>> CORRUPTING_RECIPE;
    public static Supplier<RecipeSerializer<CorruptingRecipe>> CORRUPTING_RECIPE_SERIALIZER;
    ...
    public static Supplier<MenuType<EnderFurnaceMenu>> ENDER_FURNACE_MENU;
    public static Supplier<MenuType<PoweredEnderFurnaceMenu>> POWERED_ENDER_FURNACE_MENU;
