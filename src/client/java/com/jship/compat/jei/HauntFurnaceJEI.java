...
public class HauntFurnaceJEI implements IModPlugin {
    ...
    public static final Identifier ID = new Identifier(HauntFurnace.MOD_ID, "jei_plugin");
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        List<HauntingRecipe> recipes = recipeManager.listAllOfType(HauntFurnace.HAUNTING_RECIPE);
