...
public class HauntFurnaceREIClient implements REIClientPlugin {
    ...
    public static final CategoryIdentifier<HauntingRecipeClientDisplay> HAUNTING = CategoryIdentifier.of(HauntFurnace.MOD_ID,
    ...
    public void registerDisplays(DisplayRegistry registry) {
        registry.beginRecipeFiller(FurnaceRecipeDisplay.class)
            ...
            .filter((display, r) -> EntryIngredients.ofSlotDisplay(display.craftingStation()).contains(EntryStacks.of(HauntFurnace.HAUNT_FURNACE_ITEM.get())))
