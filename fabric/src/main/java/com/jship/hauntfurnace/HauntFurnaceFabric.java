...
public class HauntFurnaceFabric implements ModInitializer {
        ...
        private static AbstractCookingRecipe.Serializer<HauntingRecipe> HAUNTING_RECIPE_SERIALIZER;
        private static RecipeBookCategory HAUNTING_RECIPE_BOOK_CATEGORY;
        ...
        static {
                ...
                HAUNT_FURNACE_BLOCK_ENTITY = Registry.register(
                                ...
                                ResourceLocation.fromNamespaceAndPath(HauntFurnace.MOD_ID, "haunt_furnace"),
                                FabricBlockEntityTypeBuilder.create(HauntFurnaceBlockEntity::new, HAUNT_FURNACE_BLOCK).build());
                ...
                HAUNTING_RECIPE_BOOK_CATEGORY = Registry.register(
                ...
                HAUNTING_RECIPE_SERIALIZER = Registry.register(
                                ...
                                ResourceLocation.fromNamespaceAndPath(HauntFurnace.MOD_ID, "haunting"),
                                new AbstractCookingRecipe.Serializer(HauntingRecipe::new, 200));
        ...
        public void onInitialize() {
                ...
                HauntFurnace.HAUNTING_RECIPE_BOOK_CATEGORY = () -> HAUNTING_RECIPE_BOOK_CATEGORY;
